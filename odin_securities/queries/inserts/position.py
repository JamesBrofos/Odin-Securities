...
def position(position, sid, pid):
    props = "{}".format((
        sid, pid, position.quantity, position.direction.value,
    ...
    symbol_id, portfolio_id, quantity, direction, trade_type,
    date_entered, avg_price, buys, sells, avg_buys_price,
    avg_sells_price, tot_buys_price, tot_sells_price, tot_commission
    ) VALUES {}
    """.format(props))
